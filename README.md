...
또한, 이 과정에서 사용자는 의류 피팅 정도를 Fit, Standard, Loose 중에서 선택할 수 있다. 이를 통해 사용자들은 자신에게 맞는 의류를 아바타를 통해 시도하고, 실제로 착용한듯한 경험을 할 수 있을 것이며 이는 소비자들이 흔히 느끼는 온라인 쇼핑의 불편함을 해소할 수 있을 것이다. 
